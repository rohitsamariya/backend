...
const checkEmailLogDetails = async () => {
    try {
        ...
        console.log(`Detailed Email History for ${user.name}:`);
        user.emailHistory.slice(-10).forEach(h => {
            console.log(`- Type: ${h.emailType}, Status: ${h.status}, Error: ${h.smtpResponse}, SentAt: ${h.sentAt}`);
        });
